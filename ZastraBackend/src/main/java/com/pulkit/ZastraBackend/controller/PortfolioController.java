...
import com.pulkit.ZastraBackend.dto.response.PortfolioPublicResponse;
...
public class PortfolioController {
    ...
    public ResponseEntity<PortfolioPublicResponse> getPublicPortfolio(@PathVariable String username) {
